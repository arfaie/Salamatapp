...
namespace Application.Areas.Admin.Controllers
{
    ...
    public class InformingPrivateController : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly IServiceProvider _serviceProvider;
        private readonly IHostingEnvironment _appEnvironmen;
        public InformingPrivateController(ApplicationDbContext context, IServiceProvider serviceProvider, IHostingEnvironment appEnvironmen)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var select = await _context.tbl_Informing.Where(x => x.flag == true && x.privatePer == true).ToListAsync();
            ...
            informingNavbar.Informings = select;
        ...
        [HttpGet]
        public async Task<IActionResult> AddEditInformingPrivate(int Id)
        {
            ...
            return PartialView("AddEditInformingPrivate", Informing);

        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddEditInformingPrivate(tbl_Informing model, int id, string redirecturl, IEnumerable<IFormFile> files, string Imgename)
        {
            ...
            else
            {
                ...
                return PartialView("AddEditInformingPrivate", model);
            }
           
        }

        [HttpGet]
        public async Task<IActionResult> DeleteInformingPrivate(int Id)
        {
            var Informing = new tbl_Informing();
            if (Id != 0)
            {
            ...
            return PartialView("DeleteInformingPrivate", Informing.infoDes);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteInformingPrivate(int id, string redirecturl)
        {
            if (ModelState.IsValid)
            {
